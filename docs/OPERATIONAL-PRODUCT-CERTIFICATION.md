...
- The complete backend suite now discovers 97 tests and passes 96 with one PostgreSQL-trigger assertion intentionally skipped under SQLite. The PostgreSQL 16 scoped suite independently passes that trigger coverage.
