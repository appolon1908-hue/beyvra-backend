...
from .consumers import AssetConsumer, CryptoMarketDataConsumer, StockMarketDataConsumer, CurrentBalanceConsumer, ProfitLossConsumer, LiveMarketDataConsumer
...
websocket_urlpatterns = [
    ...
    re_path(r"ws/market-data/$", LiveMarketDataConsumer.as_asgi()),
]
