...
class WithdrawalRequestCreateWithBank(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if bank_account and bank_account.user != user:
            raise ValidationError("The provided bank account does not belong to the user.")
...
class BankAccountSerializer(serializers.ModelSerializer):
    ...
    withdrawal_request = WithdrawalRequestCreateWithBank(write_only=True, required=False)
    ...
    def create(self, validated_data):
        ...
        if withdrawal_request_data:
            WithdrawalRequest.objects.create(bank_account=bank_account, user=user, **withdrawal_request_data)
