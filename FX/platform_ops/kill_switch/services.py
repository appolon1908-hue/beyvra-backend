...
class KillSwitchService:
    @staticmethod
    @transaction.atomic
    def activate(*,code,actor,reason_code,request_id=None,correlation_id=None):
        ...
        record_operator_action(actor=actor,action="kill_switch.activated",object_ref=code,reason_code=reason_code,request_id=request_id,correlation_id=correlation_id); return switch
    @staticmethod
    def request_deactivation(*,code,actor,reason_code,request_id=None,correlation_id=None):
        ...
        record_operator_action(actor=actor,action="kill_switch.deactivation_requested",object_ref=code,reason_code=reason_code,request_id=request_id,correlation_id=correlation_id); return req
    @staticmethod
    @transaction.atomic
    def approve_deactivation(*,code,request_id,actor,audit_request_id=None,correlation_id=None):
        ...
        record_operator_action(actor=actor,action="kill_switch.deactivated",object_ref=code,reason_code=req.reason_code,request_id=audit_request_id,correlation_id=correlation_id); return req.switch
