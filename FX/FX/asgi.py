...
"""
from wsnotifications.routing import ws_notificationswebsocket_urlpatterns
import os
...
application = ProtocolTypeRouter(
    {
        ...
        "websocket": CustomTokenAuthMiddleware(
            URLRouter(
                portfolio_websocket_urlpatterns + ws_websocket_urlpatterns + ws_notificationswebsocket_urlpatterns
            )
        ),
    }
)
