...
urlpatterns = [
    ...
    path("api/v1/realtime/ticket", realtime_v2.realtime_ticket_v1, name="realtime_ticket_v1"),
    path("api/v1/realtime/snapshot", realtime_v2.realtime_snapshot_v1, name="realtime_snapshot_v1"),
    path("api/v1/realtime/resume", realtime_v2.realtime_resume_v1, name="realtime_resume_v1"),
