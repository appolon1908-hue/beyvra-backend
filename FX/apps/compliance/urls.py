...
urlpatterns = [
    path("profile", ComplianceProfileView.as_view()), path("profile/", ComplianceProfileView.as_view()),
    path("requirements", ComplianceRequirementsView.as_view()), path("requirements/", ComplianceRequirementsView.as_view()),
