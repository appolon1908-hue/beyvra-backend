...
class Migration(migrations.Migration):
    ...
    operations=[
        ...
        migrations.RunSQL(IMMUTABLE_SQL, reverse_sql="DROP TRIGGER IF EXISTS trading_reconciliation_violation_append_only ON canonical_trading_reconciliationviolation; DROP TRIGGER IF EXISTS trading_reconciliation_run_append_only ON canonical_trading_reconciliationrun; DROP FUNCTION IF EXISTS trading_reject_reconciliation_mutation();"),
    ]
