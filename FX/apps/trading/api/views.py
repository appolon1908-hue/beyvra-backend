...
def _context(request):
    ...
    return org, ComplianceProfile.objects.filter(organization_id=org, user=request.user).first() if org else None

def _eligibility(request, context_ref=""):
    _, profile = _context(request)
