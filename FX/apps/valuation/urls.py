...
from .portfolio_api import PortfolioAllocationsView, PortfolioPerformanceView, PortfolioRiskView, PortfolioSummaryView
urlpatterns=[
 ...
 path("portfolio/summary",PortfolioSummaryView.as_view()),path("portfolio/performance",PortfolioPerformanceView.as_view()),path("portfolio/allocations",PortfolioAllocationsView.as_view()),path("portfolio/risk",PortfolioRiskView.as_view()),
]
